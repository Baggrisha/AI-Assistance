...
- 🔊 Озвучка ответов
- 🎙️ Голосовой ввод через GigaAM (кнопка записи в интерфейсе)
...
HF_TOKEN=TOKEN
VOICE_ENABLED="0"
GIGAAM_API_URL="https://api.gigaam.ru/v1/stt"
GIGAAM_API_KEY="YOUR_TOKEN"
```
...
> Для голосового ввода укажи `GIGAAM_API_KEY` в `.env` и жми кнопку 🎙 в интерфейсе — запись отправится в GigaAM и текст сразу уйдёт в чат.
